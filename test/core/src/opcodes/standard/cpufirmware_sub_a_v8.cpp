...
namespace sleepy
{
	TEST_CASE("CpuFirmware_SUB_A_V8")
	{
		SECTION("SUB_A_V8_SubtractionIsCorrect")
		{
			...
			u8 expectedValue = 0x00;

			regs.a = 0xFA;
			sub_a_a.call(nullptr);
			expectedValue = U8(0xFA - 0xFA);
			REQUIRE(expectedValue == regs.a);

			regs.a = 0xFA;
			regs.b = 0x0B;
			sub_a_b.call(nullptr);
			expectedValue = U8(0xFA - 0x0B);
			REQUIRE(expectedValue == regs.a);

			regs.a = 0xFA;
			regs.c = 0x0C;
			sub_a_c.call(nullptr);
			expectedValue = U8(0xFA - 0x0C);
			REQUIRE(expectedValue == regs.a);

			regs.a = 0xFA;
			regs.d = 0x0D;
			sub_a_d.call(nullptr);
			expectedValue = U8(0xFA - 0x0D);
			REQUIRE(expectedValue == regs.a);

			regs.a = 0xFA;
			regs.e = 0x0E;
			sub_a_e.call(nullptr);
			expectedValue = U8(0xFA - 0x0E);
			REQUIRE(expectedValue == regs.a);

			regs.a = 0xFA;
			regs.h = 0xA0;
			sub_a_h.call(nullptr);
			expectedValue = U8(0xFA - 0xA0);
			REQUIRE(expectedValue == regs.a);

			regs.a = 0xFA;
			regs.l = 0xAF;
			sub_a_l.call(nullptr);
			expectedValue = U8(0xFA - 0xAF);
			REQUIRE(expectedValue == regs.a);
